...
class EnphaseBatteryGridControl {
    ...
    async getToken() {
        ...
        return (0, node_fetch_1.default)('https://api.enphaseenergy.com/oauth/token', {
            method: 'post',
            body: authPArams,
    ...
    async authenticate() {
        ...
        return (0, node_fetch_1.default)(`https://api.enphaseenergy.com/api/v4/systems/{system_id}/summary?key=${encodeURIComponent(this.config.APIKey)}`, {
